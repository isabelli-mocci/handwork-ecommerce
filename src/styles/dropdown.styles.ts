const DROPDOWN_CLASSES = {
  wrapper: 'relative inline-flex items-center border border-secondary rounded-sm px-2',
  ...
  svg: 'w-4 h-4 text-secondary ml-auto',
  list: 'absolute left-0 top-full w-full bg-[#f5f0ec] border border-secondary z-50 py-2 min-w-[130px] shadow-lg',
